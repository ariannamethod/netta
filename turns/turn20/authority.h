#ifndef NETTA_TURN20_AUTHORITY_H
#define NETTA_TURN20_AUTHORITY_H

typedef enum { AR_SLOW = 0, AR_FAST, AR_ADAPTIVE, AR_WITNESS, AR_CEILING,
               AR_WITNESSED_CEILING, AR_MODES } ARMode;
...
/* Only prediction state, never world IDs, labels, outcomes or trace statistics.
   ...
   AR_ADAPTIVE, turn18's signed wrongness w under AR_WITNESS/AR_CEILING/
   AR_WITNESSED_CEILING. The record stays
...
/* The observed byte is charged before this call. matched is the episode
   ...
   hazard-updated odds exceeded the mode's next-quote cap; it is not persistent state.
